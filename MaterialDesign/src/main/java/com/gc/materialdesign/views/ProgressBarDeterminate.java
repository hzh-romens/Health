...
public class ProgressBarDeterminate extends CustomView {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Color by resource
        int bacgroundColor = attrs == null ? -1 : attrs.getAttributeResourceValue(ANDROIDXML, "background", -1);
        if (bacgroundColor != -1) {
        ...
        min = attrs == null ? 0 : attrs.getAttributeIntValue(MATERIALDESIGNXML, "min", 0);
        max = attrs == null ? 100 : attrs.getAttributeIntValue(MATERIALDESIGNXML, "max", 100);
        progress = attrs == null ? min : attrs.getAttributeIntValue(MATERIALDESIGNXML, "progress", min);
