...
public class NotificationCenter {
    ...
    //siery
    public static final int localLoginSuccess = totalEvents++;
    public static final int serverLoginSuccess = totalEvents++;
    public static final int didPhotoFinishEdit = totalEvents++;
    public static final int userSortChanged = totalEvents++;
    public static final int didContactLoaded = totalEvents++;
    public static final int didContactUpdated = totalEvents++;
    public static final int needLogout = totalEvents++;

    //message
    public static final int receivedNewMessage = totalEvents++;
    public static final int loadMessagesUpdated = totalEvents++;

    public static final int newGroupCreated = totalEvents++;
    public static final int chatOpened = totalEvents++;
    public static final int chatClosed = totalEvents++;

    public static final int messageFileDidFailedLoad = totalEvents++;
    public static final int messageFileDidLoaded = totalEvents++;
    public static final int messageFileLoadProgressChanged = totalEvents++;

    //User
    public static final int userProfileChanged = totalEvents++;
    public static final int userListChanged = totalEvents++;

    // must last position
    public static final int maxCursor = totalEvents++;

    //群成员变更
    public static final int onGroupMemberChanged = totalEvents++;
