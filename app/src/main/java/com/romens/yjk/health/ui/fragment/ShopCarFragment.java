...
public class ShopCarFragment extends AppFragment {
    ...
    public void setTitleView(boolean hide) {
        this.isVisible = hide;
    }

    private void initView(View view) {
        titleView = (RelativeLayout) view.findViewById(R.id.title_background);
                ...
                public void onResult(Message msg, Message errorMsg) {
                    ...
                    if (errorMsg == null) {
                        ...
                        try {
                            ...
                            String success = jsonObject.getString("success");
                            if (success.equals("yes")) {
                                Intent i = new Intent(getActivity(), OrderSubmitBaseActivity.class);
