...
public class SupportCell  extends FrameLayoutFixed {
    ...
    public SupportCell(Context context) {
        ...
        addView(textView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, (Gravity.LEFT) | Gravity.TOP, 17, 10, 17, 0));
        ...
        addView(valueTextView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.WRAP_CONTENT, (Gravity.LEFT) | Gravity.TOP, 17, 35, 17, 0));
    }
