...
public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit() {
        ...
        // 初始化环信SDK,一定要先调用init()
        EMChat.getInstance().init(MyApplication.applicationContext);
    ...
    private String getAppName(int pID) {
        ...
        ActivityManager am = (ActivityManager) MyApplication.applicationContext.getSystemService(Context.ACTIVITY_SERVICE);
        List l = am.getRunningAppProcesses();
        Iterator i = l.iterator();
        PackageManager pm = MyApplication.applicationContext.getPackageManager();
        while (i.hasNext()) {
