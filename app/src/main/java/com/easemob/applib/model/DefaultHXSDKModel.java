...
public class DefaultHXSDKModel extends HXSDKModel{
    ...
    public DefaultHXSDKModel(){
        HXPreferenceUtils.init(MyApplication.applicationContext);
    }
    ...
    public boolean saveHXId(String hxId) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(MyApplication.applicationContext);
